...
public class ActionEventController implements Constants {
    ...
    @ApiOperation(value = "Получить объект события по услуге", notes = "##### Пример:\n"
            + "http://alpha.test.igov.org.ua/wf/service/action/event/getHistoryEvent_Service?nID_Protected=11\n"
    ...
    @ApiOperation(value = "добавляет объект события по услуге", notes = ""
            ...
            + "пример: http://alpha.test.igov.org.ua/wf/service/action/event/addHistoryEvent_Service?nID_Process=2&sUserTaskName=new&nID_Subject=2&sProcessInstanceName=test_bp\n\n"
            + "ответ:\n\n"
            + "\n```json\n"
            + "{\n"
            + "    \"sID\":null,\n"
    ...
    @ApiOperation(value = "Обновить объект события по услуге", notes = "##### Пример:\n"
            + "http://alpha.test.igov.org.ua/wf/service/action/event/updateHistoryEvent_Service?nID_Process=1&sUserTaskName=finish \n"
    ...
    HistoryEvent_Service updateHistoryEvent_Service(
            @ApiParam(value = "строка-ид события по услуге, в формате XXX-XXXXXX = nID_Server-nID_Protected", required = false) @RequestParam(value = "sID_Order", required = false) String sID_Order,
    ...
    @ApiOperation(value = "Проверка наличия задачи определенного Бизнес процесса (БП), указанного гражданина", notes
            = "##### Примеры:\n"
            + "http://alpha.test.igov.org.ua/wf/service/action/task/event/getLastTaskHistory?nID_Subject=2&nID_Service=1&sID_UA=1200000000\n\n"
    ...
    @ApiOperation(value = "Сохранение события в Мой Журнал", notes = "##### Пример:\n"
            + "http://alpha.test.igov.org.ua/wf/service/action/event/setHistoryEvent")
    ...
    @ApiOperation(value = "Получение события истории по его id", notes = "\n"
            ...
            + "https://alpha.test.igov.org.ua/wf/service/action/event/getHistoryEvent?nID=11\n\n"
            + "\n```json\n"
            + "{\n"
            ...
            + "https://alpha.test.igov.org.ua/wf/service/action/event/getHistoryEvent?nID=12\n\n"
            + "\n```json\n"
            + "{\n"
            + "  \"sMessage\": \"Новая заявка создана_11\",\n"
            + "  \"sDate\": \"2015-07-04 12:18:56.235\",\n"
    ...
    @ApiOperation(value = "Загрузка событий", notes
            = "Пример 1: http://alpha.test.igov.org.ua/wf/service/action/event/getServicesStatistics?nID_Subject=10\n\n"
            + "Пример 2: http://alpha.test.igov.org.ua/wf/service/action/event/getServicesStatistics?nID_Subject=10&nID_HistoryEvent_Service=2\n\n"
    ...
    @ApiOperation(value = "Получение количества записей HistoryEvent_Service для сервиса по регионам", notes
            = "##### Примеры:\n"
            + "https://alpha.test.igov.org.ua/wf/service/action/event/getStatisticServiceCounts?nID_Service=26\n\n"
            + "Результат\n"
            + "\n```json\n"
            + "[\n"
            + "  {\n"
    ...
    @ApiOperation(value = "Получение статистики по сервисам и регионам за заданный промежуток времени", notes
            = "##### Примеры:\n"
            + "https://alpha.test.igov.org.ua/wf/service/action/event/getServicesStatistic?sDate_from=2010-07-04 12:09:56&sDate_to=2019-07-04 12:09:56\n\n"
            + "Результат\n"
            + "\n```csv\n"
