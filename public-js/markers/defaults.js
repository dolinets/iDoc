  ...
  .factory('iGovMarkersDefaults', function () {
    var defaultMarkers = {
      validate: {
        ...
        ,SJAN: {
          aField_ID: ['sJan', 'sFeb', 'sMar', 'sApr', 'sMay', 'sJun', 'sJul', 'sAug', 'sSep', 'sOct', 'sNov', 'sDec']
        }
        ,StrictOrdersValue: {
          aField_ID: ['sOrder_1'],
          bAsync: true //set to TRUE when use Angular`s async validator
        }
        ,OrderValue: {
          aField_ID: ['sOrder_1']
        }
...
/*
        ValuesFieldsOnCondition_st_3:{
          aField_ID:["nSumInCassete2"],
          asID_Field_sValue:["[digit2]*[nDenomination2]"],
          asID_Field:{"sClient":"digit1"},
          bIsCalculated:true,
