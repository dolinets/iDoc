...
public class DocumentAccessController {
    ...
    @ApiOperation(value = "Получение контента документа по коду доступа,оператору, типу документа и паролю", notes = ""
            + "Пример: https://alpha.test.igov.org.ua/wf/service/document/access/getDocumentAccessByHandler?sCode_DocumentAccess=2&nID_DocumentOperator_SubjectOrgan=2&sPass=123&nID_DocumentType=1\n\n"
