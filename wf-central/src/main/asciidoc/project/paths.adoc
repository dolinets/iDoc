...
----
GET /action/event/getServicesStatisticsOfDnepr
----
...
|===
|Type|Name|Description|Required|Schema|Default
|QueryParameter|sID_Order|строка-ид события по услуге, в формате XXX-XXXXXX = nID_Server-nID_Protected|false|string|
...
|QueryParameter|bRecursive|булевый флаг. если true -- удалять рекурсивно все данные связанные с подкатегорией. Если false, то при наличии вложенных сущностей, ссылающихся на эту, подкатегория удалена не будет|false|boolean|
|===
...
|QueryParameter|bShowEmptyFolders|булевый флаг. Возвращать или нет пустые категории и подкатегории (по умолчанию false)|false|boolean|
...
https://alpha.test.region.igov.org.ua/wf/service/action/task/searchTasks?nSize=25&nStart=0&sOrderBy=asc
{
  ...
  "sDateType": null, 
  "sProcessDefinitionKey": "_doc_btsol_vertical_sz",
  "sDateFrom": "2017-11-10",
  "sDateTo": "2017-11-15",
  "sLoginController": null,
  "sLoginExecutor": null,
  "sFind": "13.11",
  "sFilterStatus": "DocumentOpenedUnassignedUnprocessed",
  "bIncludeDeleted": null,
...
|BodyParameter|sBody|JSON c параметрами|true|string|
|===
...
HTTP Context: https://alpha.test.region.igov.org.ua/wf/service/action/task/getCountTask?sLogin=[sLogin]?&amFilter=[amFilter]
...
===== Description
:hardbreaks:
##### Сохранение файла-образа документа (исходного)

===== Parameters
[options="header"]
|===
|Type|Name|Description|Required|Schema|Default
|QueryParameter|sID_Token|sID_Token|false|string|
|BodyParameter|file|файл для сохранения в БД|true|string|
|===
...
===== Description
:hardbreaks:
##### Получение файла-образа документа (исходного)

===== Parameters
[options="header"]
|===
|Type|Name|Description|Required|Schema|Default
|QueryParameter|nID|nID|false|string|
|QueryParameter|sSecret|sSecret|false|string|
|===
...
===== Description
:hardbreaks:
##### Получение информации по файлу-образу документа
...
:hardbreaks:
Пример:
https://alpha.test.igov.org.ua/wf/service/finance/getMerchantsResponse
...
:hardbreaks:
Пример:
https://alpha.test.igov.org.ua/wf/service/finance/removeMerchant?sID=i10172968078Response
Status 200
...
|QueryParameter|nID_Subject|номер-ИД субьекта|true|integer (int64)|
|QueryParameter|sExpired_Period_Hour|количество часов актуальности платежа|true|integer (int32)|
|===
...
|QueryParameter|file_sign|Документ для передачи в веб сервис министерства юстиции|true|multi string array|
|QueryParameter|file_stamp|Подпись документа для передачи в веб сервис министерства юстиции|true|multi string array|
|===
...
:hardbreaks:
##### Пример:
https://alpha.test.region.igov.org.ua/wf/service/chat/process/updateProcessChatMessage?nID_Process_Activiti=3805456&sKeyGroup=1&sKeyGroup_Author=Author&sBody=test&nID_ProcessChatMessage=1002 
...
:hardbreaks:
##### Пример:
https://alpha.test.region.igov.org.ua/wf/service/chat/process/setProcessChatMessage?nID_Process_Activiti=3805456&sKeyGroup=1&sKeyGroup_Author=Author&sBody=test&nID_ProcessChatMessage_Parent=1000 
...
==== Тест LaunchService
----
GET /process/processlink/getProcessLinksExternal
----

===== Description
:hardbreaks:
##### Пример:
https://alpha.test.region.igov.org.ua/wf/service/process/processlink/getProcessLinksExternal 
...
|===
|Type|Name|Description|Required|Schema|Default
|QueryParameter|saAccount|Массив с логинами чиновников в виде json|true|string|
...
|Type|Name|Description|Required|Schema|Default
|QueryParameter|sID|sID - кретерий поиска в sID (без учета регистра, в любой части текста)|false|string|
|QueryParameter|sNote|sNote - кретерий поиска в sNote (без учета регистра, в любой части текста)|false|string|
|===
...
|QueryParameter|nID|Порядковый ID должности|false|integer (int64)|
|===
...
|===
|Type|Name|Description|Required|Schema|Default
|QueryParameter|nID_SubjectMessage|номер-ИД записи с сообщением|true|string|
|QueryParameter|nID_Subject|Номер-ИД субьекта (хозяина заявки сообщения)|false|integer (int64)|
|QueryParameter|bAuth|булевский флаг, Включить авторизацию|false|boolean|
|===
...
|QueryParameter|nID_SubjectMessageType|Номер-ИД типа сообщения|true|integer (int64)|
|===
...
|QueryParameter|bSelf|Собственный контр-ответ автора фидбека|true|boolean|
