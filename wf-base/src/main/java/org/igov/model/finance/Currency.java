...
@ApiModel(description="Валюты")
public class Currency extends AbstractEntity {

    @JsonProperty(value = "sID_UA")
    @Column(length = 10, unique = true)
    @ApiModelProperty(value = "Уникальная строка-ИД кода валюты", required = true)
    private String sID_UA;

    @JsonProperty(value = "sName_UA")
    @Column(length = 200, unique = true)
    @ApiModelProperty(value = "Название валюты на украинском", required = true)
    private String sName_UA;

    @JsonProperty(value = "sName_EN")
    @Column(length = 200, unique = true)
    @ApiModelProperty(value = "Название валюты на английском", required = true)
    private String sName_EN;

    @JsonProperty(value = "sID_Currency")
    @Column(length = 10, unique = true)
    @ApiModelProperty(value = "Уникальная строка-ИД кода аббревиатуры валюты", required = true)
