...
module.exports.getMinJustForm = function (req, res) {
  var sHost = req.region.sHost;
  var sUrl = '';
  ...
  activiti.get(sUrl, {
    sID_NAIS_Application_id: req.query.sID_NAIS_Application_id,
    sID_NAIS_Service_code: req.query.sID_NAIS_Service_code
  }, callback, sHost);
};
