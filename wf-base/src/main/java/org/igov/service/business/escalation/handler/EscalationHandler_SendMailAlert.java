...
public class EscalationHandler_SendMailAlert implements EscalationHandler {
    ...
    @Override
    public void execute(Map<String, Object> mParam, String[] asRecipientMail, String sPatternFile, String sHead) throws Exception {
        String sBody = null;
        ...
        if(sHead == null){
            ...
            sHead = sHead.replaceAll("\\[sID_BP\\]", (String)mParam.get("sID_BP"));
            sHead = sHead.replaceAll("\\[nID_Task\\]", ((Long) mParam.get("nID_task_activiti")).toString());
            
            LOG.info("sHead after replasing is {}", sHead);
        }
