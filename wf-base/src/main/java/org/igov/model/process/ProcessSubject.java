...
public class ProcessSubject extends AbstractEntity {
    ...
    @JsonProperty(value = "nDeep")
    @Column
    private int nDeep;
    
    @JsonProperty(value = "nDayPlan")
    @Column
    private Integer nDayPlan;
    ...
    public void setsText(String sText) {
        this.sText = (sText != null && sText.length() > 2400) ? sText.substring(0, 2399) : sText;
    }
    ...
    public Integer getnDayPlan() {
        return nDayPlan;
    }

    public void setnDayPlan(Integer nDayPlan) {
