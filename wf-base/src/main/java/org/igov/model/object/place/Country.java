...
@ApiModel(description="Страны мира")
public class Country extends AbstractEntity {
    ...
    @Column(unique = true)
    @ApiModelProperty(value = "Уникальный номер-ИД страны по классификатору Украины", required = true)
    private Long nID_UA;
    ...
    @ApiModelProperty(value = "Уникальная строка-ИД страны (двухсимвольный код) (международный уникальный-ключ, String 2 символа)", required = true)
    ...
    @ApiModelProperty(value = "Уникальная строка-ИД страны (трехсимвольный код) (международный уникальный-ключ, String 3 символа)", required = true)
    ...
    @ApiModelProperty(value = "Краткое название страны (укр.язык)", required = true)
    ...
    @Column(length = 100, unique = true)
    @ApiModelProperty(value = "Краткое название страны (анг.язык)", required = true)
    ...
    @Column(length = 100)
    @ApiModelProperty(value = "Ссылка на локальный ISO-стандарт, с названием (a-teg с href)", required = true)
