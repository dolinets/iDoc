...
public class ActionTaskController {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ActionTaskController.class);
    ...
    @ApiOperation(value = "Получение полей стартовой формы по: ИД субьекта, ИД услуги, ИД места Услуги", notes = ""
            ...
            + "Примеры:\n"
            + "https://alpha.test.igov.org.ua/wf-central/service/action/task/getStartFormByTask_Central?nID_Subject=2&nID_Service=1&sID_UA=1200000000\n\n"
