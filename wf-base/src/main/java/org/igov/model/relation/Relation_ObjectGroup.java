...
@ApiModel(value = "Справочник связок групп товаров из ObjectGroup")
public class Relation_ObjectGroup extends AbstractEntity{
    ...
    @ApiModelProperty(value = "Уникальный номер-ИД связи групп в справочнике", required = true)
    ...
    @ApiModelProperty(value = "Уникальный номер-ИД подчиненной группы", required = true)
    ...
    @ApiModelProperty(value = "Уникальный номер-ИД главной группы", required = true)
