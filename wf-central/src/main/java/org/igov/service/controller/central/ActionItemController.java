...
public class ActionItemController {
    ...
    @ApiOperation(value = "Получение сервиса", notes = "#####Пример:\n"
            + "https://alpha.test.igov.org.ua/wf/service/action/item/getService?nID=1\n\n"
            + "\n```json\n"
            + "Ответ:\n"
            + "{\n"
    ...
    @ApiOperation(value = "Изменение сервиса.", notes
            ...
            + "\n```json\n"
            + "Пример:\n"
            + "https://alpha.test.igov.org.ua/wf/service/action/item/setService\n"
            + "{\n"
            + "    \"sSubjectOperatorName\": \"МВС\",\n"
            + "    \"subjectOperatorName\": \"МВС\",\n"
            + "    \"nID\": 1,\n"
    ...
    @ApiOperation(value = "Удаление сервиса", notes = ""
            ...
            + "Пример 1:\n"
            + "https://alpha.test.igov.org.ua/wf/service/action/item/removeService?nID=1\n\n"
            + "Ответ 1: HTTP STATUS 304\n\n"
            + "Пример 2: https://alpha.test.igov.org.ua/wf/service/action/item/removeService?nID=1&bRecursive=true\n"
    ...
    @ApiOperation(value = "Удаление сущности ServiceData", notes = ""
            ...
            + "HTTP STATUS 200 - удаление успешно. HTTP STATUS 304 - не удалено.\n\n"
            + "Пример:\n"
            + "https://alpha.test.igov.org.ua/wf/service/action/item/removeServiceData?nID=1&bRecursive=true\n\n"
    ...
    @ApiOperation(value = "Удаление подкатегории", notes = ""
            ...
            + "HTTP STATUS 200 - удаление успешно. HTTP STATUS 304 - не удалено.\n\n"
            + "Пример 1:\n"
            + "https://alpha.test.igov.org.ua/wf/service/action/item/removeSubcategory?nID=1\n"
            + "Ответ 1: HTTP STATUS 304\n\n"
            + "Пример 2:\n"
            + "https://alpha.test.igov.org.ua/wf/service/action/item/removeSubcategory?nID=1&bRecursive=true\n\n"
            + "Ответ 2: HTTP STATUS 200\n"
            + "\n```json\n"
            + "{\n"
            + "    \"code\": \"success\",\n"
    ...
    ResponseEntity removeSubcategory(
            ...
            @ApiParam(value = "булевый флаг. если true -- удалять рекурсивно все данные связанные с подкатегорией. "
                    + "Если false, то при наличии вложенных сущностей, ссылающихся на эту, подкатегория удалена не будет", required = false) @RequestParam(value = "bRecursive", required = false) Boolean bRecursive) {
        bRecursive = (bRecursive == null) ? false : bRecursive;
        ResponseEntity response;
        if (bRecursive) {
    ...
    @ApiOperation(value = "Удаление категории", notes = ""
            ...
            + "HTTP STATUS 200 - удаление успешно. HTTP STATUS 304 - не удалено.\n\n"
            + "Пример 1:\n"
            + "https://alpha.test.igov.org.ua/wf/service/action/item/removeCategory?nID=1\n"
            + "Ответ 1: HTTP STATUS 304\n\n"
            + "Пример 2:\n"
            + "https://alpha.test.igov.org.ua/wf/service/action/item/removeCategory?nID=1&bRecursive=true\n"
            + "Ответ 2: HTTP STATUS 200\n"
            + "\n```json\n"
            + "{\n"
            + "    \"code\": \"success\",\n"
    ...
    @ApiOperation(value = "Удаление всего дерева сервисов и категорий", notes = ""
            ...
            + "Пример 1:\n"
            + "https://alpha.test.igov.org.ua/wf/service/action/item/removeServicesTree\n"
            + "\n```json\n"
    ...
    @ApiOperation(value = "Получение дерева сервисов", notes = "Дополнительно:\n"
            ...
            + "Пример: \n"
            + "https://alpha.test.igov.org.ua/wf/service/action/item/getServicesTree?asID_Place_UA=3200000000,8000000000\n\n"
            + "Ответ:\n"
            + "\n```json\n"
            + "[\n"
            + "  {\n"
    ...
    @ApiOperation(value = "Изменение дерева категорий", notes = " Можно менять категории (не добавлять и не удалять) + "
            ...
            + "Пример: https://alpha.test.igov.org.ua/wf/service/action/item/setServicesTree\n"
            + "\n```json\n"
            + "[\n"
            + "  	{\n"
            + "  		\"nID\": 1,\n"
    ...
    ResponseEntity<String> getCatalogTreeTag(
            ...
            @ApiParam(value = "булевый флаг. Возвращать или нет пустые категории и подкатегории (по умолчанию false)", required = false)
    ...
    ResponseEntity<String> getCatalogTreeTagService(
            ...
            @RequestParam(value = "nID_Place_Profile", required = false) Long nID_Place_Profile, @ApiParam(value = "булевый флаг. Возвращать или нет пустые категории и подкатегории (по умолчанию false)", required = false)
