...
var all = {
  ...
  main_env: {
    ...
    ProjectRegion_MainPage_biDocOnly: config.getProperty('ProjectRegion_MainPage_biDocOnly')|| process.env.ProjectRegion_MainPage_biDocOnly,
    ProjectRegion_StartView_bDocuments: config.getProperty('ProjectRegion_StartView_bDocuments') || process.env.ProjectRegion_StartView_bDocuments,
    bHelpDesk: config.getProperty('bHelpDesk') || process.env.bHelpDesk
  }
};
