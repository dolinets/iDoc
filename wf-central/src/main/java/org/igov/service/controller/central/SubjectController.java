...
public class SubjectController {
    ...
    @ApiOperation(value = "/getSubjectHuman", notes = "##### SubjectController - Субъекты  и смежные сущности. Получение объекта SubjectHuman по номеру #####\n\n"
            ...
            + "Примеры:\n\n"
            + "https://alpha.test.igov.org.ua/wf/service/subject/getSubjectHuman?nID_Subject=1\n\n"
            + "Response\n"
            + "\n```json\n"
            + "{\"oSubject\":\n"
            + "\t{\"sID\":\"2872618515\",\n"
    ...
    @ApiOperation(value = "/getSubjectOrgan", notes = "##### SubjectController - Субъекты  и смежные сущности. Получение объекта SubjectOrgan по номеру #####\n\n"
            ...
            + "Если объект с заданным номером на найден - возвращается код 404\n"
            + "Примеры:\n\n"
            + "https://alpha.test.igov.org.ua/wf/service/subject/getSubjectOrgan?nID_Subject=1\n\n"
            + "Response\n"
            + "\n```json\n"
            + "{\"oSubject\":\n"
            + "\t{\"sID\":\"ПАО\",\n"
    ...
    @ApiOperation(value = "Возвратить весь список таможенных органов", notes = "##### SubjectController - Субъекты  и смежные сущности. Возвратить весь список таможенных органов #####\n\n"
            ...
            + "Пример: https://alpha.test.igov.org.ua/wf/service/subject/getSubjectOrganJoinTax\n")
    ...
    @ApiOperation(value = "Получает весь массив объектов джоинов субьектов-органа п.2 (либо всех либо в рамках заданных в запросе nID_Region, nID_City или sID_UA)", notes = "##### SubjectController - Субъекты  и смежные сущности. Получает весь массив объектов п.2 (либо всех либо в рамках заданных в запросе nID_Region, nID_City или sID_UA) #####\n\n"
            ...
            + "\n```\n"
            + "Пример:\n\n"
            + "https://alpha.test.igov.org.ua/wf/service/subject/getSubjectOrganJoins?nID_SubjectOrgan=1&sID_UA=1\n")
    ...
    @ApiOperation(value = "Добавить/обновить массив объектов", notes = "##### SubjectController - Субъекты  и смежные сущности. Добавить/обновить массив объектов п.2 (сопоставляя по ИД, и связывая новые с nID_Region, nID_City или sID_UA, по совпадению их названий) #####\n\n"
            + "Пример:\n"
            + "https://alpha.test.igov.org.ua/wf/service/subject/setSubjectOrganJoin?nID_SubjectOrgan=1&sNameRu=Днепр.РОВД\n")
    ...
    @ApiOperation(value = "Удаление массива объектов п.2 (находя их по ИД)", notes = "##### SubjectController - Субъекты  и смежные сущности. Удаление массива объектов п.2 (находя их по ИД) #####\n\n"
            + "Пример: \n"
            + "https://alpha.test.igov.org.ua/wf/service/subject/removeSubjectOrganJoins?nID_SubjectOrgan=1&asID_Public=130505,130506,130507,130508\n")
    ...
    @ApiOperation(value = "Синхронизация контактов", notes = "#### Пример: \n"
            + "https://alpha.test.igov.org.ua/wf/service/subject/syncContacts?snID_Subject=2&sMailTo=test44@gmail.com&sPhone=654 \n"
            + "Ответ: \n"
            + "HTTP Status: 200 \n"
            + "\n```json\n"
            + "["
    ...
    @ApiOperation(value = "Получение аккаунтов субъектов", notes = "Возвращает список аккаунтов субъектов, согласно заданных параметров. "
            ...
            + "Пример:\n"
            + "https://alpha.test.igov.org.ua/wf/service/subject/getSubjectAccounts?nID_Subject=1&nID_Server=1\n"
            + "Ответ:\n"
            + "\n```json\n"
            + "[\n"
            + "  {\n"
            ...
            + "https://alpha.test.igov.org.ua/wf/service/subject/getSubjectAccounts\n"
            + "Ответ:\n"
            + "\n```json\n"
            + "{\"code\":\"BUSINESS_ERR\",\"message\":\"Error! Parameters nID_Subject and  sLogin is null\"}\n"
            + "\n```\n"
            + "Пример, если записи не найдены:\n"
            + "https://alpha.test.igov.org.ua/wf/service/subject/getSubjectAccounts?nID_Subject=1&nID_Server=100\n"
            + "Ответ:\n"
            + "\n```json\n"
            + "{\n"
            + "  \"code\":\"BUSINESS_ERR\",\n"
    ...
    @ApiOperation(value = "Добавление/обновление аккаунта субъекта", notes = "Добавляет или обновляет аккаунт субъекта в зависимости от того задан или нет параметр **nID**. "
            ...
            + "https://alpha.test.igov.org.ua/wf/service/subject/setSubjectAccount?nID_Subject=1&sLogin=mylog&nID_Server=55&nID_SubjectAccountType=2&sNote=Заметка_про_что-то\n\n"
            + "Ответ:\n"
            + "\n```json\n"
            + "{\n"
            + "  \"sLogin\": \"mylog\",\n"
            ...
            + "https://alpha.test.igov.org.ua/wf/service/subject/setSubjectAccount?nID=1&sNote=Заметка_обновленная\n\n"
            + "Ответ:\n"
            + "\n```json\n"
            + "{\n"
            + "  \"sLogin\": \"Логин01\",\n"
            ...
            + "https://alpha.test.igov.org.ua/wf/service/subject/setSubjectAccount\n\n"
            + "Ответ:\n"
            + "\n```json\n"
            + "{\n"
            + "  \"code\": \"BUSINESS_ERR\",\n"
            ...
            + "https://alpha.test.igov.org.ua/wf/service/subject/setSubjectAccount?nID_Subject=1&sLogin=Логин01&nID_Server=1&nID_SubjectAccountType=1\n\n"
            + "Ответ:\n"
            + "\n```json\n"
            + "{\n"
            + "  \"code\": \"SYSTEM_ERR\",\n"
            ...
            + "https://alpha.test.igov.org.ua/wf/service/subject/setSubjectAccount?nID=777\n\n"
            + "Ответ:\n"
            + "\n```json\n"
            + "{\n"
            + "  \"code\": \"BUSINESS_ERR\",\n"
    ...
    SubjectAccount setSubjectAccount(
        ...
        try {
            ...
            SubjectUtils.checkID(subjectAccountRet);
    ...
    @ApiOperation(value = "Получение полного набора данных по субъектам", notes = "Получаем полный набор данных по субъектам. "
            + "Пример:\n"
            + "https://alpha.test.igov.org.ua/wf/service/subject/getSubjectsBy\n\n"
    ...
    Map<String, List<NewSubjectAccount>> getSubjectsBy(
            @ApiParam(value = "Массив с логинами чиновников в виде json", required = true) @RequestParam(value = "saAccount", required = true) String saAccount,
...
//         LOG.info("subject: " + subject);
    ...
    List<SubjectActionKVED> getActionKVED2(
            ...
            @ApiParam(value = "sNote - кретерий поиска в sNote (без учета регистра, в любой части текста)", required = false) @RequestParam(value = "sNote", required = false) String sNote)
        	    throws CommonServiceException {
