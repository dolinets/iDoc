...
@ApiModel(description="Ответвление субьекта-организации (юрлица)")
public class SubjectOrganJoin extends AbstractEntity {

    @Column(name = "nID_SubjectOrgan")
    @ApiModelProperty(value = "Номер-ИД субъекта-организации, корневой (на что 'вяжется' запись)", required = false)
    ...
    @Column(name = "sNameUa")
    @ApiModelProperty(value = "Название на украинском")
    private String nameUa;

    @JsonProperty(value = "sNameRu")
    @Column(name = "sNameRu")
    @ApiModelProperty(value = "Название на русском")
    ...
    @ApiModelProperty(value = "Строка-ИД частный, уникальный (внутренний, <60 символов)", required = false)
    private String privatId;

    @JsonProperty(value = "sID_Public")
    @Column(name = "sID_Public")
    @ApiModelProperty(value = "Строка-ИД публичный, уникальный (внешний, <60 символов)", required = false)
    private String publicId;

    @JsonProperty(value = "sGeoLongitude")
    @Column(name = "sGeoLongitude")
    @ApiModelProperty(value = "Строка координаты-долготы", required = false)
    private String geoLongitude;

    @JsonProperty(value = "sGeoLatitude")
    @Column(name = "sGeoLatitude")
    @ApiModelProperty(value = "Строка координаты-широты", required = false)
    private String geoLatitude;

    @JsonProperty(value = "nID_Region")
    @Column(name = "nID_Region")
    @ApiModelProperty(value = "Номер-ИД региона(области)")
    private Long regionId;

    @JsonProperty(value = "nID_City")
    @Column(name = "nID_City")
    @ApiModelProperty(value = "Номер-ИД города")
    private Long cityId;

    @JsonProperty(value = "sID_UA")
    @Column(name = "sID_UA")
    @ApiModelProperty(value = "Строка-ИД украинского классификатора КОАТУУ, уникальный")
    private String uaId;
