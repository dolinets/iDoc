...
public class DocumentController {
    ...
    @ApiOperation(value = "Получение документа по ид документа", notes = ""
            + "Пример: https://alpha.test.igov.org.ua/wf/service/document/getDocument?nID=1\n"
            + "Response\n"
            + "\n```json\n"
            + "{\n"
    ...
    @ApiOperation(value = "Получение всех операторов(органов) которые имею право доступа к документу", notes = ""
            + "Примеры: https://alpha.test.igov.org.ua/wf/service/document/getDocumentOperators\n"
            + "Response\n"
            + "\n```json\n"
            + "[\n"
            + "    {\n"
    ...
    @ApiOperation(value = "Получение контента документа по ид документа", notes = ""
            + "Пример: https://alpha.test.igov.org.ua/wf/service/document/getDocumentContent?nID=1\n"
    ...
    @ApiOperation(value = "Получение документа в виде файла по ид документа", notes = ""
            + "Пример: https://alpha.test.igov.org.ua/wf/service/document/getDocumentFile?nID=1\n"
    ...
    @ApiOperation(value = "Получение документа в виде файла", notes = ""
            + "Пример: https://alpha.test.igov.org.ua/wf/service/document/getDocumentAbstract?sID=150826SV7733A36E803B\n"
            + "Response ЗАГРУЖЕННЫЙ ФАЙЛ\n")
    ...
    @ApiOperation(value = "Получение списка загруженных субъектом документов", notes = ""
            + "Пример: https://alpha.test.igov.org.ua/wf/service/document/getDocuments?nID_Subject=2\n"
            + "Response\n"
            + "\n```json\n"
            + "[\n"
            + "  {\n"
    ...
    @ApiOperation(value = "Сохранение документа", notes = "Пример:\n"
            + "https://alpha.test.igov.org.ua/wf/service/document/setDocument?sID_Subject_Upload=123&sSubjectName_Upload=Vasia&sName=Pasport&sFile=file.txt&nID_DocumentType=1&sDocumentContentType=application/zip&soDocumentContent=ffffffffffffffffff&nID_Subject=1\n\n"
    ...
    @ApiOperation(value = "Получение списка всех \"нескрытых\" типов документов", notes = ""
            + "Пример: https://alpha.test.igov.org.ua/wf/service/document/getDocumentTypes\n"
            + "Response\n"
            + "\n```json\n"
            + "[\n"
    ...
    @ApiOperation(value = "Добавить/изменить запись типа документа", notes = "Примеры:\n"
            + "создать новый тип: https://alpha.test.igov.org.ua/wf/service/document/setDocumentType?nID=100&sName=test\n"
            + "Ответ: \n"
            + "\n```json\n"
            + "{\"nID\":20314,\"sName\":\"test\", , \"bHidden\":false}\n"
            + "\n```\n"
            + "изменить (взять ид из предыдущего ответа): https://alpha.test.igov.org.ua/wf/service/document/setDocumentType?nID=20314&sName=test2\n"
            + "Ответ: \n"
            + "\n```json\n"
    ...
    @ApiOperation(value = "Удаление записи по ее ид", notes = ""
            ...
            + "Пример: https://alpha.test.igov.org.ua/wf/service/document/removeDocumentType?nID=20314\n"
            + "Ответ: 200 ok\n")
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Получение списка типов контента документов", notes = ""
            + "Пример: https://alpha.test.igov.org.ua/wf/service/document/getDocumentContentTypes\n"
            + "Response\n"
            + "\n```json\n"
            + "[\n"
    ...
    @ApiOperation(value = "Добавить/изменить запись типа контента документа", notes = ""
            ...
            + "Примеры:\n\n"
            + "создать новый тип: \n"
            + "https://alpha.test.igov.org.ua/wf/service/document/setDocumentContentType?nID=100&sName=test\n\n"
            + "Ответ:\n"
            + "\n```json\n"
            + "{\"nID\":20311,\"sName\":\"test\"}\n"
            + "\n```\n"
            + "изменить (взять ид из предыдущего ответа): \n"
            + "https://alpha.test.igov.org.ua/wf/service/document/setDocumentContentType?nID=20311&sName=test2\n\n"
            + "Ответ:\n"
            + "\n```json\n"
    ...
    @ApiOperation(value = "Удаление записи по ее ид", notes = ""
            + "Если запись с ид=nID не будет найдена, то вернется ошибка 403. Record not found, иначе -- запись удалится.\n\n"
            + "Пример:\n"
            + "https://alpha.test.igov.org.ua/wf/service/document/removeDocumentContentType?nID=20311\n\n"
            + "Ответ: 200 ok\n")
    @ApiResponses(value = {
        @ApiResponse(code = 403, message = "Record not found")})
