...
@ApiModel(description="Классификация видов экономической деятельности Украины (КВЕД)")
public class SubjectActionKVED extends AbstractEntity {

    private static final long serialVersionUID = -3659824409047841264L;

    @Column
    @ApiModelProperty(value = "Уникальная строка-ИД позиции классификатора видов экономической деятельности (КВЕД)", required = true)
    private String sID;
