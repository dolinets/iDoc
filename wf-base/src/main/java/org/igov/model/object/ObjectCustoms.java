...
@ApiModel(description="Украинская классификация товаров ВЭД")
        
public class ObjectCustoms extends AbstractEntity
{
    @JsonProperty(value = "sID_UA")
    @Column(name="sID_UA", length=30, nullable=false)
    @ApiModelProperty(value = "Уникальная строка-ИД классификации товаров ВЭД", required = true)
    private String sID_UA;
    
    
    @JsonProperty(value = "sName_UA")
    @Column(name="sName_UA", length=5000, nullable=false)
    @ApiModelProperty(value = "Название позиции классификатора товаров ВЭД", required = true)
    private String sName_UA;
    
    
    @JsonProperty(value = "sMeasure_UA")
    @Column(name="sMeasure_UA", length=20)
    @ApiModelProperty(value = "Название едений измерения позиции классификатора товаров ВЭД", required = true)
