...
public final class Tool {
    ...
    private static final String sa = "абвгдеёжзийклмнопрстуфхцчшщъыьэюяієї";
    private static final String[] as = { "a", "b", "v", "g", "d", "e", "yo", "j", "z", "i", "y",
            "k", "l", "m", "n", "o", "p", "r", "s", "t", "u",
            "f", "h", "tz", "ch", "sh", "sh", "'", "i", "'", "e", "yu", "ya", "i", "e", "i"};
