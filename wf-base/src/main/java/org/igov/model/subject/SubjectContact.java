...
@ApiModel(description="Контакт субъекта")
...
public static NewSubjectContact getNewSubjectContact(SubjectContact subjectContact){
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof SubjectContact)) {
            return false;
        }
        final SubjectContact that = (SubjectContact) obj;
        return getsValue().equals(that.getsValue()) &&
            getSubjectContactType().equals(that.getSubjectContactType());
    }

    @Override
    public int hashCode() {
        int nSubjectContactType = 1;
        SubjectContactType oSubjectContactType = getSubjectContactType();
        if (oSubjectContactType != null) {
            nSubjectContactType = oSubjectContactType.hashCode();
        }
        return 47 * getsValue().hashCode() + 11 * nSubjectContactType;
    }
