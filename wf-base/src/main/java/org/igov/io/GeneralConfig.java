...
public class GeneralConfig {
    ...
    @Value("${general.Self.bSkipSlotGeneration}")
    private Boolean bSkipSlotGeneration;
    ...
    @Value("${general.Self.bDocumentUrgentBlock}")
    private Boolean bDocumentUrgentBlock;

    @Value("${general.Self.isHolding}")
    private Boolean isHolding;

    @Value("${general.Self.bStartEscalation}")
    private Boolean bStartEscalation;
    
    @Value("${general.openDataBot.api.commonInfo}")
    private String sURL_OpenDataBot_CommonInfo;
    ...
    public Boolean isSkipSlotGeneration() {
        return bSkipSlotGeneration;
    }
    ...
    public Long getProtectedNumber_ByProcess(String snID_Process) {
        return getProtectedNumber(Long.valueOf(snID_Process));
    }
    ...
    public String getProcessIdBysID_Order(String sID_Order) {
        String snID_Process;
        if (sID_Order != null && sID_Order.contains("-")) {
            long nID_Process_Protected = Long.valueOf(sID_Order.split("-")[1]);
            snID_Process = String.valueOf(ToolLuna.getOriginalNumber(nID_Process_Protected));
        } else {
            throw new IllegalArgumentException("Wrong sID_Order for parsing!");
        }
        return snID_Process;
    }
    ...
    public Boolean isDocumentUrgentBlock() {
        return bDocumentUrgentBlock;
    }
    ...
    public Boolean getbStartEscalation() {
        return bStartEscalation;
    }
    
    public String getsURL_OpenDataBot_CommonInfo() {
        return sURL_OpenDataBot_CommonInfo;
    }
    
    public String getsDocumentURL(String sID_Order) {
        String sTemplate = "/documents/sID_Order=";
        return createURL(sID_Order, sTemplate);
    }
    
    public String getsTaskURL(String sID_Order) {         
        String sTemplate = "/tasks/sID_Order=";
        return createURL(sID_Order, sTemplate);       
    }
    
    private String createURL(String sID_Order, String sTemplate){
        Long nID = getSelfServerId().longValue();
        Server oServer = oServerDao.findByIdExpected(nID);
        String sServerURL = oServer.getsURL();    
        String sBody = sServerURL + sTemplate + sID_Order;
