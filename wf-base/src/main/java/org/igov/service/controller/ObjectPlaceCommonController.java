...
import org.igov.model.object.place.ObjectPlace_UA;
import org.igov.model.object.place.ObjectPlace_UADao;
...
@Controller
@Api(tags = {"ObjectPlaceCommonController -- Обьекты мест (населенных пунктов и регионов) и стран"})
