...
public class MUController {
    ...
    String getObjectEarthTargets(
            ...
            @ApiParam(value = "Документ для передачи в веб сервис министерства юстиции", required = true) @RequestParam("file_sign") byte[] file_sign,
            @ApiParam(value = "Подпись документа для передачи в веб сервис министерства юстиции", required = true) 
